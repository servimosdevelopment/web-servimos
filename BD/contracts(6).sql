...
--
-- Servidor: localhost
-- Tiempo de generación: 26-05-2024 a las 08:39:59
...
CREATE TABLE `contrato` (
  ...
  `tipo` enum('1','0') CHARACTER SET utf8mb4 DEFAULT NULL COMMENT 'Tipo de contrato',
...
CREATE TABLE `dotacion` (
  ...
  `fecha_tentativa_renovar` date DEFAULT NULL,
  `observacion` text
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `empresa` (
  `id` int NOT NULL,
  `nit` varchar(20) CHARACTER SET utf8mb4 NOT NULL,
...
INSERT INTO `empresa` (`id`, `nit`, `nombre`, `direccion`, `telefono`, `email`, `representante_legal`, `activo`) VALUES
(3, '1111', 'Prueba 1', 'jajaj', '11111', 'jaja@gmail.com', 'Pepipto Perez', '1'),
(4, '6666', 'Prueba 2', 'Sincelejo', '345551', 'juan@gmail.com', 'Juan Reyes', '1'),
(5, '666666', 'Boston', 'Boston', '566278', 'juan@gmail.com', 'Juan reyes', '1');
...
CREATE TABLE `persona` (
  `id` int NOT NULL,
  `cedula` varchar(20) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT 'Número de cédula de la persona',
  `nombre` varchar(255) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT 'Nombres y apellidos completos de la persona',
  `sexo` enum('M','F') CHARACTER SET utf8mb4 DEFAULT NULL COMMENT 'Sexo de la persona',
  ...
  `departamento_residencia` int UNSIGNED DEFAULT NULL,
  `municipio_residencia` int UNSIGNED DEFAULT NULL,
  `direccion` varchar(255) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT 'Dirección de la persona',
  `barrio` varchar(100) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT 'Barrio de residencia de la persona',
  `tipo_sangre` int DEFAULT NULL COMMENT 'ID del tipo de sangre de la persona',
  `eps` varchar(40) DEFAULT NULL,
  `afp` varchar(40) DEFAULT NULL,
  `estado_civil` varchar(40) DEFAULT NULL COMMENT 'Estado civil de la persona',
  ...
  `hijos` text CHARACTER SET utf8mb4,
  `telefono` varchar(20) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT 'Teléfono personal de contacto de la persona',
  `whatsapp` varchar(20) CHARACTER SET utf8mb4  DEFAULT NULL COMMENT 'Número de WhatsApp de la persona',
  `email` varchar(255) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT 'Correo electrónico activo de la persona',
...
INSERT INTO `persona` (`id`, `cedula`, `nombre`, `sexo`, `fecha_nacimiento`, `fecha_expedicion_cedula`, `edad`, `departamento_nacimiento`, `municipio_nacimiento`, `departamento_residencia`, `municipio_residencia`, `direccion`, `barrio`, `tipo_sangre`, `eps`, `afp`, `estado_civil`, `id_estrato`, `id_escolaridad`, `hijos`, `telefono`, `whatsapp`, `email`, `contacto_emergencia`, `activo`) VALUES
(9, '1005488389', 'Juan Felipe Reyes Herrera', 'M', '1999-04-26', '2017-05-17', 25, 70, 624, 70, 624, 'San Rafael', 'La esmeralda', 7, 'Mutual Ser', 'No aplica', 'Soltero/a', 1, 7, 'No aplica', '3114030928', '3114030928', 'rhjuanfe-26@hotmail.com', 'Carmen Herrera \r\n3205123068', 1);

--
-- Disparadores `persona`
--
DELIMITER $$
CREATE TRIGGER `calcular_edad_before_insert` BEFORE INSERT ON `persona` FOR EACH ROW BEGIN
    SET NEW.edad = TIMESTAMPDIFF(YEAR, NEW.fecha_nacimiento, CURDATE());
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `calcular_edad_before_update` BEFORE UPDATE ON `persona` FOR EACH ROW BEGIN
    SET NEW.edad = TIMESTAMPDIFF(YEAR, NEW.fecha_nacimiento, CURDATE());
END
$$
DELIMITER ;
...
CREATE TABLE `usuarios` (
  ...
  `rol` enum('1','2') CHARACTER SET utf8mb4 DEFAULT '1' COMMENT 'Rol del usuario',
...
ALTER TABLE `dotacion`
  ADD PRIMARY KEY (`id`),
  ADD KEY `dotacion_ibfk_1` (`persona_id`);
...
ALTER TABLE `persona`
  ...
  ADD KEY `fk_dep_nacimiento` (`departamento_nacimiento`),
  ADD KEY `fk_mun_nacimiento` (`municipio_nacimiento`),
  ADD KEY `fk_dep_residencia` (`departamento_residencia`),
  ADD KEY `fk_mun_residencia` (`municipio_residencia`);
...
ALTER TABLE `vacaciones`
  ADD PRIMARY KEY (`id`),
  ADD KEY `vacaciones_ibfk_1` (`persona_id`);
...
--
ALTER TABLE `municipios`
  MODIFY `id_municipio` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1101;
...
--
ALTER TABLE `contrato`
  ADD CONSTRAINT `fk_contrato_empresa` FOREIGN KEY (`empresa_id`) REFERENCES `empresa` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_contrato_persona` FOREIGN KEY (`id_persona`) REFERENCES `persona` (`id`) ON DELETE SET NULL;

--
-- Filtros para la tabla `dotacion`
--
ALTER TABLE `dotacion`
  ADD CONSTRAINT `dotacion_ibfk_1` FOREIGN KEY (`persona_id`) REFERENCES `persona` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `municipios`
--
ALTER TABLE `municipios`
  ADD CONSTRAINT `fk_departamento` FOREIGN KEY (`departamento_id`) REFERENCES `departamentos` (`id_departamento`);

--
-- Filtros para la tabla `persona`
--
ALTER TABLE `persona`
  ADD CONSTRAINT `fk_dep_nacimiento` FOREIGN KEY (`departamento_nacimiento`) REFERENCES `departamentos` (`id_departamento`),
  ADD CONSTRAINT `fk_dep_residencia` FOREIGN KEY (`departamento_residencia`) REFERENCES `departamentos` (`id_departamento`),
  ADD CONSTRAINT `fk_mun_nacimiento` FOREIGN KEY (`municipio_nacimiento`) REFERENCES `municipios` (`id_municipio`),
  ADD CONSTRAINT `fk_mun_residencia` FOREIGN KEY (`municipio_residencia`) REFERENCES `municipios` (`id_municipio`),
...
--
ALTER TABLE `vacaciones`
  ADD CONSTRAINT `vacaciones_ibfk_1` FOREIGN KEY (`persona_id`) REFERENCES `persona` (`id`) ON DELETE CASCADE;
COMMIT;
